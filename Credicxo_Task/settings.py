...
SECRET_KEY = '3avb1fxfyw4^&z*+bc40lip4(lya-gazjil2@eds*wo!$7_#_e'
...
MIDDLEWARE = [
    # need to add a middleware class to listen in on responses.
    # CORS
...
# need to setup PostgreSQL Database engine.
